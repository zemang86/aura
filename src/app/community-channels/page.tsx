    ...
    <div className="page-shell">
      <section className="page-hero">
        <div className="page-hero-inner">
          <div className="page-hero-meta">Community · Official channels</div>
          <h1>
            Our community <em>channels.</em>
          </h1>
          <p className="page-hero-deck">
            These are the only official Aura FHE channels. If anyone contacts
            you off-channel claiming to represent Aura — they don&rsquo;t.
          </p>
        </div>
      </section>
            ...
            {CHANNELS.map((c) => {
              ...
              const children = (
                <>
                  ...
                  <p>
                    {c.label === "Discord"
                      ? "Real-time questions, ecosystem chatter, fastest path in."
                      : c.label === "X"
                        ? "Long-form research notes, milestone announcements."
                        : c.label === "LinkedIn"
                          ? "Company updates, partnerships, hiring."
                          : "Engineering notes on FHE, private DeFi, and the cryptography behind Aura."}
                  </p>
