  ...
  return (
    <section className="w-full bg-white py-[14px]">
      <div className="mx-auto flex h-[720px] max-w-[1200px] flex-col items-center justify-center gap-9 px-5 md:px-9">
        ...
        <div className="flex h-[392px] w-full items-center justify-center border border-dashed border-border-token text-muted-text">
          <p className="text-p14">
            Calculator embed placeholder (commoninja third-party widget — wire
            up later)
          </p>
        </div>
      </div>
